...
import { n as runExec } from "./exec-CTJFoTnU.js";
import { t as normalizeChatType } from "./chat-type-uz-WJTy4.js";
import { _ as isAudioFileName, h as getFileExtension, p as detectMime, y as kindFromMime } from "./image-ops-BN-gQcBh.js";
import { E as normalizeProviderId, M as normalizeGoogleModelId, _ as resolveOpenClawAgentDir, i as resolveApiKeyForProvider, r as requireApiKey } from "./model-auth-DUBAGAng.js";
import { n as loadConfig } from "./config-C-jA90S6.js";
import { t as describeImageWithModel, x as ensureOpenClawModelsJson } from "./image-BmFSAvE-.js";
import { n as fetchWithTimeout } from "./fetch-timeout-BheTNyes.js";
import { i as fetchWithSsrFGuard, n as fetchRemoteMedia, t as MediaFetchError } from "./fetch-CcQo7_WG.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-CvOm0Qeg.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-CLr-I7Ta.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
