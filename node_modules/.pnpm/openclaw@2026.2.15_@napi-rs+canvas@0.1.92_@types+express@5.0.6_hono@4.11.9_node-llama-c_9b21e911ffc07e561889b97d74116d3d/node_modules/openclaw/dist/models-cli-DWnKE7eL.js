...
import { It as formatUsageWindowSummary, Lt as resolveUsageProviderId, Pt as loadProviderUsageSummary, Z as describeFailoverError, m as runEmbeddedPiAgent } from "./reply-B1AnbNl6.js";
import "./registry-D74-I5q-.js";
import { f as defaultRuntime } from "./subsystem-CiM1FVu6.js";
import "./exec-DSVXqxGa.js";
import { E as resolveDefaultAgentWorkspaceDir, a as resolveAgentModelPrimary, c as resolveDefaultAgentId, i as resolveAgentModelFallbacksOverride, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-5j4KiZmG.js";
import { G as resolveEnvApiKey, Ot as resolveAuthStorePathForDisplay, Pt as resolveAuthProfileDisplayLabel, Q as shouldEnableShellEnvFallback, Rt as DEFAULT_MODEL, St as upsertAuthProfile, U as resolveApiKeyForProvider, V as getCustomProviderApiKey, W as resolveAwsSdkEnvVarName, c as normalizeProviderId, ct as resolveAuthProfileOrder, f as resolveConfiguredModelRef, ft as resolveProfileUnusableUntilForDisplay, h as resolveModelRefFromString, kt as resolveOpenClawAgentDir, l as parseModelRef, o as modelKey, p as resolveDefaultModelForAgent, q as getShellEnvAppliedKeys, r as buildModelAliasIndex, wt as ensureAuthProfileStore, xt as setAuthProfileOrder, yt as listProfilesForProvider, zt as DEFAULT_PROVIDER } from "./model-selection-DnrWKBOM.js";
...
import { _ as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot } from "./config-DTlZk19z.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-CS8MdUIx.js";
...
import { i as resolveForwardCompatModel, r as ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES } from "./model-DO6y7gYr.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-D2X_bDLt.js";
import { r as withProgressTotals } from "./progress-DDsYyzm-.js";
...
import { f as openUrl } from "./onboard-helpers-vhMfSJom.js";
...
import { a as isLocalBaseUrl, c as resolveKnownAgentId, d as updateConfig, i as formatTokenK, l as resolveModelKeysFromEntries, n as ensureFlagCompatibility, o as mergePrimaryFallbackConfig, r as formatMs, s as normalizeAlias, t as applyDefaultModelPrimaryUpdate, u as resolveModelTarget } from "./shared-DdvyCVeh.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-oyH5CUBR.js";
import { n as logConfigUpdated } from "./logging-CM4P2SKc.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-CCu3wUXc.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-DTlZk19z.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./model-selection-DnrWKBOM.js").then((n) => n.st);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-DO6y7gYr.js").then((n) => n.t);
