...
import { a as resolveTelegramAccount } from "./normalize-DiPfVVz6.js";
import { t as isTruthyEnvValue } from "./env-BDzJYlvR.js";
import { n as listChannelPlugins, t as getChannelPlugin } from "./plugins-BmVEQmtR.js";
import { C as mediaKindFromMime, b as normalizeMimeType, h as getFileExtension, v as isGifMedia } from "./image-ops-BN-gQcBh.js";
import { v as withFileLock$1 } from "./model-auth-DUBAGAng.js";
import { n as loadConfig } from "./config-C-jA90S6.js";
import { t as redactSensitiveText } from "./redact-BjQ9RIiE.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-CsoDC3nn.js";
...
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-Ddq1rNcH.js";
import { t as makeProxyFetch } from "./proxy-Dvn2GZAo.js";
...
//#endregion
export { hasBotMention as A, resolveSenderAllowMatch as B, buildTelegramGroupPeerId as C, describeReplyTarget as D, buildTypingThreadParams as E, resolveTelegramStreamMode as F, removeChannelAllowFromStoreEntry as G, toLocationContext as H, resolveTelegramThreadSpec as I, listPairingChannels as J, upsertChannelPairingRequest as K, firstDefined as L, resolveTelegramForumThreadId as M, resolveTelegramGroupAllowFromContext as N, expandTextLinks as O, resolveTelegramReplyId as P, isSenderAllowed as R, buildTelegramGroupFrom as S, buildTelegramThreadParams as T, addChannelAllowFromStoreEntry as U, formatLocationText as V, readChannelAllowFromStore as W, parseTelegramTarget as X, isVoiceCompatibleAudio as Y, splitTelegramCaption as _, sendMessageTelegram as a, buildSenderLabel as b, send_exports as c, isRecoverableTelegramNetworkError as d, markdownToTelegramChunks as f, resolveTelegramFetch as g, wrapFileReferencesInHtml as h, reactMessageTelegram as i, normalizeForwardedContext as j, extractTelegramLocation as k, resolveTelegramVoiceSend as l, renderTelegramHtmlText as m, deleteMessageTelegram as n, sendPollTelegram as o, markdownToTelegramHtml as p, getPairingAdapter as q, editMessageTelegram as r, sendStickerTelegram as s, buildInlineKeyboard as t, wasSentByBot as u, withTelegramApiErrorLogging as v, buildTelegramParentPeer as w, buildSenderName as x, buildGroupLabel as y, normalizeAllowFromWithStore as z };