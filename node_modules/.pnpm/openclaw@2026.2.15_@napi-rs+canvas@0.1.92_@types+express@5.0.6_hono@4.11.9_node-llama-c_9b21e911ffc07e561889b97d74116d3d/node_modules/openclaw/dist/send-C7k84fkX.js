...
import { c as getFileExtension, d as isGifMedia, g as mediaKindFromMime, p as normalizeMimeType } from "./image-ops-Dmx5NOjU.js";
import { a as resolveTelegramAccount } from "./normalize-CEDF7eBP.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-Cc0AOOs4.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-DwRJAzeS.js";
import { t as renderMarkdownWithMarkers } from "./render-BBWKrfmg.js";
import { n as normalizePollInput } from "./polls-CWeTecVx.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-cMUrV5zA.js";
import { t as resolveFetch } from "./fetch-C7NGXnMU.js";
import { i as readChannelAllowFromStore } from "./pairing-store-CXkP5_3O.js";
import { t as makeProxyFetch } from "./proxy-C6uKGYuE.js";
...
//#endregion
export { normalizeForwardedContext as A, formatLocationText as B, buildTelegramParentPeer as C, expandTextLinks as D, describeReplyTarget as E, resolveTelegramThreadSpec as F, withTelegramApiErrorLogging as H, firstDefined as I, isSenderAllowed as L, resolveTelegramGroupAllowFromContext as M, resolveTelegramReplyId as N, extractTelegramLocation as O, resolveTelegramStreamMode as P, normalizeAllowFromWithStore as R, buildTelegramGroupPeerId as S, buildTypingThreadParams as T, isVoiceCompatibleAudio as U, toLocationContext as V, parseTelegramTarget as W, splitTelegramCaption as _, sendMessageTelegram as a, buildSenderName as b, send_exports as c, isRecoverableTelegramNetworkError as d, markdownToTelegramChunks as f, resolveTelegramFetch as g, wrapFileReferencesInHtml as h, reactMessageTelegram as i, resolveTelegramForumThreadId as j, hasBotMention as k, resolveTelegramVoiceSend as l, renderTelegramHtmlText as m, deleteMessageTelegram as n, sendPollTelegram as o, markdownToTelegramHtml as p, editMessageTelegram as r, sendStickerTelegram as s, buildInlineKeyboard as t, wasSentByBot as u, buildGroupLabel as v, buildTelegramThreadParams as w, buildTelegramGroupFrom as x, buildSenderLabel as y, resolveSenderAllowMatch as z };