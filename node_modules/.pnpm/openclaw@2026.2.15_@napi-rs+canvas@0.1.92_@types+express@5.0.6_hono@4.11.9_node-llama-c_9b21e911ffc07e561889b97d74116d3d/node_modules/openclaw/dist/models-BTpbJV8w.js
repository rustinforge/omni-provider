...
import { B as resolveModelRefFromString, C as resolveOpenClawAgentDir, Ft as DEFAULT_MODEL, It as DEFAULT_PROVIDER, L as resolveConfiguredModelRef, Lt as resolveAuthProfileDisplayLabel, N as normalizeProviderId, O as buildModelAliasIndex, P as parseModelRef, R as resolveDefaultModelForAgent, S as resolveAuthStorePathForDisplay, Tt as shouldEnableShellEnvFallback, bt as getShellEnvAppliedKeys, ft as getCustomProviderApiKey, g as upsertAuthProfile, gt as resolveEnvApiKey, h as setAuthProfileOrder, ht as resolveAwsSdkEnvVarName, j as modelKey, mt as resolveApiKeyForProvider, n as resolveAuthProfileOrder, o as resolveProfileUnusableUntilForDisplay, p as listProfilesForProvider, v as ensureAuthProfileStore } from "./auth-profiles-GYsKiVaE.js";
...
import { i as resolveForwardCompatModel, r as ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES } from "./model-CEWuUQPV.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-EhM2JAQo.js";
import { _ as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot } from "./config-CF5WgkYh.js";
import { Bt as loadProviderUsageSummary, Ht as formatUsageWindowSummary, Ut as resolveUsageProviderId, s as runEmbeddedPiAgent, tt as describeFailoverError } from "./subagent-registry-kdTa9uwX.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-iP6tOVPR.js";
...
import { r as withProgressTotals } from "./progress-C0Eq81ZL.js";
...
import { t as createClackPrompter } from "./clack-prompter-D3HMaWhz.js";
import { t as renderTable } from "./table-ozIiGDit.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-scvX_s5g.js";
import { n as redactSecrets } from "./format-B4BvVfHq.js";
import { a as isLocalBaseUrl, c as resolveKnownAgentId, d as updateConfig, i as formatTokenK, l as resolveModelKeysFromEntries, n as ensureFlagCompatibility, o as mergePrimaryFallbackConfig, r as formatMs, s as normalizeAlias, t as applyDefaultModelPrimaryUpdate, u as resolveModelTarget } from "./shared-DQBJrhrA.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-9aoEmy6K.js";
import { n as logConfigUpdated } from "./logging-BaDbOwCs.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-LPWzmpve.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureAuthProfileStore } = await import("./auth-profiles-GYsKiVaE.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-CEWuUQPV.js").then((n) => n.t);
