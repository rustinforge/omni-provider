...
import { n as resolveAgentConfig, u as resolveSessionAgentId } from "./agent-scope-CHHM9qlY.js";
import { c as createSubsystemLogger, n as runExec, u as defaultRuntime } from "./exec-CTJFoTnU.js";
import { a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_USER_FILENAME, i as DEFAULT_HEARTBEAT_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DhQVYQ1v.js";
...
import { r as normalizeChannelId } from "./plugins-BmVEQmtR.js";
import { a as resizeToJpeg, n as getImageMetadata } from "./image-ops-BN-gQcBh.js";
import { y as isPidAlive } from "./model-auth-DUBAGAng.js";
import { o as listDeliverableMessageChannels, s as normalizeMessageChannel } from "./message-channel-B_JP848Y.js";
import { a as writeConfigFile, d as parseDurationMs, n as loadConfig, s as parseByteSize, t as createConfigIO } from "./config-C-jA90S6.js";
import { A as DEFAULT_OPENCLAW_BROWSER_ENABLED, D as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, E as DEFAULT_AI_SNAPSHOT_MAX_CHARS, O as DEFAULT_BROWSER_EVALUATE_ENABLED, T as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, h as fetchOk, i as launchOpenClawChrome, j as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, k as DEFAULT_OPENCLAW_BROWSER_COLOR, l as createTargetViaCdp, m as fetchJson, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as ensureChromeExtensionRelayServer, w as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, x as isLoopbackHost, y as stopChromeExtensionRelayServer } from "./chrome-D_KkCJSg.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, u as resolveSandboxPath } from "./skills-BvFD0bOH.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-CsoDC3nn.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-ky6KaH78.js";
import { n as resolveConversationLabel } from "./conversation-label-BLOfJHfC.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-BL4QW4f_.js";
import { n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-sVMzHKNe.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-C8Tqw4td.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-CtOU3chJ.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DDT421Jj.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-DDT421Jj.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { normalizeAccountId as $, isTransientHttpError as A, normalizeToolName as At, loadSessionStore as B, isContextOverflowError as C, resolveSandboxConfigForAgent as Ct, isRateLimitAssistantError as D, expandPolicyWithPluginGroups as Dt, isLikelyContextOverflowError as E, collectExplicitAllowlist as Et, resolveSandboxContext as F, buildBootstrapContextFiles as Ft, updateSessionStoreEntry as G, recordSessionMetaFromInbound as H, resolveSandboxRuntimeStatus as I, ensureSessionHeader$1 as It, deliveryContextFromSession as J, isCacheEnabled as K, extractDeliveryInfo as L, resolveBootstrapMaxChars as Lt, parseImageSizeError as M, stripPluginOnlyAllowlist as Mt, sanitizeUserFacingText as N, compileGlobPatterns as Nt, isRawApiErrorPayload as O, expandToolGroups as Ot, ensureSandboxWorkspaceForSession as P, matchesAnyGlobPattern as Pt, normalizeSessionDeliveryFields as Q, appendAssistantMessageToSessionTranscript as R, resolveBootstrapTotalMaxChars as Rt, isCompactionFailureError as S, resolveBrowserControlAuth as St, isFailoverErrorMessage as T, buildPluginToolGroups as Tt, updateLastRoute as U, readSessionUpdatedAt as V, updateSessionStore as W, mergeDeliveryContext as X, deliveryContextKey as Y, normalizeDeliveryContext as Z, formatRawAssistantErrorForUi as _, resolveProfile as _t, isMessagingToolDuplicateNormalized as a, resolveSessionResetType as at, isBillingAssistantError as b, getBridgeAuthForPort as bt, extractToolCallsFromAssistant as c, resolveFreshSessionTotalTokens as ct, isAntigravityClaude as d, resolveMainSessionKey as dt, acquireSessionWriteLock as et, isGoogleModelApi as f, deriveSessionMetaPatch as ft, formatBillingErrorMessage as g, resolveBrowserConfig as gt, formatAssistantErrorText as h, registerBrowserRoutes as ht, isMessagingToolDuplicate as i, resolveSessionResetPolicy as it, parseImageDimensionError as j, resolveToolProfilePolicy as jt, isTimeoutErrorMessage as k, mergeAlsoAllowPolicy as kt, extractToolResultId as l, canonicalizeMainSessionAlias as lt, classifyFailoverReason as m, createBrowserRouteContext as mt, validateGeminiTurns as n, evaluateSessionFreshness as nt, normalizeTextForComparison as o, resolveThreadFlag as ot, BILLING_ERROR_USER_MESSAGE as p, resolveGroupSessionKey as pt, resolveCacheTtlMs as q, pickFallbackThinkingLevel as r, resolveChannelResetConfig as rt, sanitizeSessionMessagesImages as s, DEFAULT_RESET_TRIGGERS as st, validateAnthropicTurns as t, resolveSessionKey as tt, downgradeOpenAIReasoningBlocks as u, resolveExplicitAgentSessionKey as ut, getApiErrorPayloadFingerprint as v, DEFAULT_UPLOAD_DIR as vt, isFailoverAssistantError as w, applyOwnerOnlyToolPolicy as wt, isCloudCodeAssistFormatError as x, ensureBrowserControlAuth as xt, isAuthAssistantError as y, resolvePathsWithinRoot as yt, resolveMirroredTranscriptText as z, sanitizeGoogleTurnOrdering as zt };