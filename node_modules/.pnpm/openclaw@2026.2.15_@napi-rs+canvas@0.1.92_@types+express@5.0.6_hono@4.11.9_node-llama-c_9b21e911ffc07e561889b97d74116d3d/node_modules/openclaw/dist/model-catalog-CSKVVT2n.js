import { C as resolveOpenClawAgentDir } from "./auth-profiles-GYsKiVaE.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-UrO1TubC.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
