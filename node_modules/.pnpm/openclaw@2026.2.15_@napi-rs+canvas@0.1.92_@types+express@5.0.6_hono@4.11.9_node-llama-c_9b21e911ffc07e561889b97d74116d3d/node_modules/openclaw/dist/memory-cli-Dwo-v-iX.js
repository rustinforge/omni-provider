...
import { d as listMemoryFiles, f as normalizeExtraMemoryPaths } from "./sqlite-DNTJEWLw.js";
import { t as formatDocsLink } from "./links-D0KDzdwy.js";
import { r as withManager } from "./cli-utils-BeUql7qI.js";
import { n as withProgress, r as withProgressTotals } from "./progress-C0Eq81ZL.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-DJ_oDAIR.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-R53uMDbK.js").then((n) => n.t);
