...
import { C as resolveOpenClawPackageRootSync, w as normalizeSkillFilter } from "./agent-scope-CXOONheC.js";
import { c as createSubsystemLogger } from "./exec-DWU0ncr5.js";
import { n as parseBooleanValue } from "./env-BMPixUW7.js";
import { c as resolveMemorySlotDecision, i as MANIFEST_KEY, o as normalizePluginsConfig, r as LEGACY_MANIFEST_KEYS, s as resolveEnableState, t as loadPluginManifestRegistry } from "./manifest-registry-C859nZr8.js";
...
function buildWorkspaceSkillSnapshot(workspaceDir, opts) {
	...
	const prompt = [opts?.eligibility?.remote?.note?.trim(), formatSkillsForPrompt(resolvedSkills)].filter(Boolean).join("\n");
