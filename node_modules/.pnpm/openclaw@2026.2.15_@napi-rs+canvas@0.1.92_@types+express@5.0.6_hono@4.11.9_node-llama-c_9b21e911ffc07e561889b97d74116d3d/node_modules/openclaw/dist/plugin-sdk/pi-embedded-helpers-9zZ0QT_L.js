import { D as normalizeE164, R as truncateUtf16Safe, j as resolveUserPath, k as resolveConfigDir, ot as resolvePreferredOpenClawTmpDir, t as CHANNEL_IDS } from "./registry-BI4o0LRR.js";
import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-ZQWYGl2V.js";
import { Y as isPidAlive } from "./model-selection-CowK-FhO.js";
import { V as parseDurationMs, a as writeConfigFile, n as loadConfig, s as parseByteSize, t as createConfigIO } from "./config-BWkAE3kO.js";
import { d as resolveAgentIdFromSessionKey, i as buildAgentMainSessionKey, l as normalizeAgentId, n as DEFAULT_AGENT_ID, u as normalizeMainKey } from "./session-key-OcC-lU-t.js";
import { _ as DEFAULT_TOOLS_FILENAME, d as DEFAULT_AGENTS_FILENAME, f as DEFAULT_AGENT_WORKSPACE_DIR, g as DEFAULT_SOUL_FILENAME, h as DEFAULT_IDENTITY_FILENAME, l as resolveSessionAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, p as DEFAULT_BOOTSTRAP_FILENAME, v as DEFAULT_USER_FILENAME, y as ensureAgentWorkspace } from "./agent-scope-CXOONheC.js";
import { c as createSubsystemLogger, d as defaultRuntime, n as runExec } from "./exec-DWU0ncr5.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as safeEqualSecret, u as resolveSandboxPath } from "./skills-Y10K9pHz.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-DsAYQPj4.js";
import { a as resizeToJpeg, n as getImageMetadata, o as detectMime, s as extensionForMime } from "./image-ops-BkWO-jIF.js";
import { n as parseBooleanValue } from "./env-BMPixUW7.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-Y1-LpZ2x.js";
import { t as normalizeChatType } from "./chat-type-DKb2TlGZ.js";
import { t as formatCliCommand } from "./command-format-BwqjySih.js";
import { r as normalizeChannelId } from "./plugins-I-9kMaQm.js";
import { a as listDeliverableMessageChannels, o as normalizeMessageChannel } from "./message-channel-D4VZ-i3l.js";
import { n as resolveConversationLabel } from "./conversation-label-C1Ak680S.js";
import { n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-Dxk5i2ju.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-Df8wfs2b.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-B0kljyLA.js";
import { C as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, D as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, E as DEFAULT_OPENCLAW_BROWSER_ENABLED, O as isLoopbackHost, S as DEFAULT_AI_SNAPSHOT_MAX_CHARS, T as DEFAULT_OPENCLAW_BROWSER_COLOR, a as resolveOpenClawUserDataDir, b as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, h as fetchOk, i as launchOpenClawChrome, l as createTargetViaCdp, m as fetchJson, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as ensureChromeExtensionRelayServer, w as DEFAULT_BROWSER_EVALUATE_ENABLED, x as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, y as stopChromeExtensionRelayServer } from "./chrome-B7Ju0OOG.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-Dzac2fQy.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-Dzac2fQy.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { normalizeToolName as $, isTransientHttpError as A, evaluateSessionFreshness as At, resolveProfile as B, resolveGroupSessionKey as Bt, isContextOverflowError as C, deliveryContextFromSession as Ct, isRateLimitAssistantError as D, normalizeSessionDeliveryFields as Dt, isLikelyContextOverflowError as E, normalizeDeliveryContext as Et, resolveSandboxContext as F, DEFAULT_RESET_TRIGGERS as Ft, resolveBrowserControlAuth as G, resolvePathsWithinRoot as H, resolveSandboxRuntimeStatus as I, resolveFreshSessionTotalTokens as It, buildPluginToolGroups as J, resolveSandboxConfigForAgent as K, createBrowserRouteContext as L, canonicalizeMainSessionAlias as Lt, parseImageSizeError as M, resolveSessionResetPolicy as Mt, sanitizeUserFacingText as N, resolveSessionResetType as Nt, isRawApiErrorPayload as O, acquireSessionWriteLock as Ot, ensureSandboxWorkspaceForSession as P, resolveThreadFlag as Pt, mergeAlsoAllowPolicy as Q, registerBrowserRoutes as R, resolveMainSessionKey as Rt, isCompactionFailureError as S, resolveCacheTtlMs as St, isFailoverErrorMessage as T, mergeDeliveryContext as Tt, getBridgeAuthForPort as U, DEFAULT_UPLOAD_DIR as V, ensureBrowserControlAuth as W, expandPolicyWithPluginGroups as X, collectExplicitAllowlist as Y, expandToolGroups as Z, formatRawAssistantErrorForUi as _, recordSessionMetaFromInbound as _t, isMessagingToolDuplicateNormalized as a, ensureSessionHeader as at, isBillingAssistantError as b, updateSessionStoreEntry as bt, extractToolCallsFromAssistant as c, sanitizeGoogleTurnOrdering as ct, isAntigravityClaude as d, saveMediaBuffer as dt, resolveToolProfilePolicy as et, isGoogleModelApi as f, extractDeliveryInfo as ft, formatBillingErrorMessage as g, readSessionUpdatedAt as gt, formatAssistantErrorText as h, loadSessionStore as ht, isMessagingToolDuplicate as i, buildBootstrapContextFiles as it, parseImageDimensionError as j, resolveChannelResetConfig as jt, isTimeoutErrorMessage as k, resolveSessionKey as kt, extractToolResultId as l, extractOriginalFilename as lt, classifyFailoverReason as m, resolveMirroredTranscriptText as mt, validateGeminiTurns as n, compileGlobPatterns as nt, normalizeTextForComparison as o, resolveBootstrapMaxChars as ot, BILLING_ERROR_USER_MESSAGE as p, appendAssistantMessageToSessionTranscript as pt, applyOwnerOnlyToolPolicy as q, pickFallbackThinkingLevel as r, matchesAnyGlobPattern as rt, sanitizeSessionMessagesImages as s, resolveBootstrapTotalMaxChars as st, validateAnthropicTurns as t, stripPluginOnlyAllowlist as tt, downgradeOpenAIReasoningBlocks as u, getMediaDir as ut, getApiErrorPayloadFingerprint as v, updateLastRoute as vt, isFailoverAssistantError as w, deliveryContextKey as wt, isCloudCodeAssistFormatError as x, isCacheEnabled as xt, isAuthAssistantError as y, updateSessionStore as yt, resolveBrowserConfig as z, deriveSessionMetaPatch as zt };